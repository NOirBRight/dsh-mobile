...
The composer plus button on a phone only offers **Command** and **Insert image**. Forwarding to the official command menu hides the Host `file` row. Images still go through the Host's official draft-image path.
