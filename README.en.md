...
Need [DeepSeek Harness](https://github.com/deepseek-ai/deepseek-harness) **0.1.2-alpha.4** through **0.1.5-rc.1**, already running on the machine the phone should reach.
...
```sh
dsh plugin --profile web add --force https://github.com/NOirBRight/dsh-mobile-pairing/releases/latest/download/dsh-mobile-pairing-0.1.17.tgz
...
```sh
dsh plugin --profile web add --force https://github.com/NOirBRight/dsh-mobile-pairing/releases/download/v0.1.17/dsh-mobile-pairing-0.1.17.tgz
...
Pairing **v0.1.17** depends on [`@dsh-mobile/e2e-tunnel` v0.1.5](https://github.com/NOirBRight/dsh-e2e-tunnel/releases/tag/v0.1.5) and is compatible with DeepSeek Harness **0.1.2-alpha.4** through **0.1.5-rc.1**. Do not add the tunnel library to the DSH plugin list; users on older Runtimes should stay on the matching older plugin versions.
...
Android APK (signed **v1.1.14**):

- Latest APK: https://github.com/NOirBRight/dsh-mobile/releases/latest/download/dsh-mobile.apk
- Fixed APK: https://github.com/NOirBRight/dsh-mobile/releases/download/v1.1.14/dsh-mobile.apk

Install the APK, open the app, scan the Host QR.

| Piece | Latest | Role |
|---|---|---|
| [dsh-mobile-pairing](https://github.com/NOirBRight/dsh-mobile-pairing) (`@dsh-mobile/pairing`) | [v0.1.17](https://github.com/NOirBRight/dsh-mobile-pairing/releases/tag/v0.1.17) | **Required.** Host plugin: QR, devices, loopback Gateway, Tunnel / Direct. This is **Remote** and supports DSH 0.1.2-alpha.4 through 0.1.5-rc.1. |
| [dsh-mobile](https://github.com/NOirBRight/dsh-mobile) Host interaction artifact (`@dsh-mobile/interaction-operations`) | [v1.1.6](https://github.com/NOirBRight/dsh-mobile/releases/download/v1.1.6/dsh-mobile-interaction-operations.tgz) | Optional Host Client plugin. Provides input/popup interaction adapters only; the mobile APK uses the same bundle locally. |
| [dsh-mobile](https://github.com/NOirBRight/dsh-mobile) mobile layout artifact (`@dsh-mobile/ui-layout-mobile`) | [v1.1.6](https://github.com/NOirBRight/dsh-mobile/releases/download/v1.1.6/dsh-mobile-ui-layout-mobile.tgz) | Narrow-screen root layout bundled in the APK; do not install it in a desktop WebUI profile. |
...
| [dsh-codex-sidebar](https://github.com/NOirBRight/dsh-codex-sidebar) | [v0.5.12](https://github.com/NOirBRight/dsh-codex-sidebar/releases/tag/v0.5.12) | **Optional.** Files / Review / Browser / Terminal in the details seat. |
| [dsh-mobile](https://github.com/NOirBRight/dsh-mobile) APK | [v1.1.14](https://github.com/NOirBRight/dsh-mobile/releases/tag/v1.1.14) | Phone app. Download the fixed-name `dsh-mobile.apk`. |
| Relay | [`relay/deploy`](relay/deploy/README.md) | Optional self-hosted sealed-frame Relay, only if you skip Quick Tunnel. |

Release integrity: APK SHA-256 is in [v1.1.14/SHA256SUMS-1.1.14](https://github.com/NOirBRight/dsh-mobile/releases/download/v1.1.14/SHA256SUMS-1.1.14); Host plugin tarballs remain in [v1.1.6/SHA256SUMS](https://github.com/NOirBRight/dsh-mobile/releases/download/v1.1.6/SHA256SUMS). Pairing integrity is in [v0.1.17/SHA256SUMS](https://github.com/NOirBRight/dsh-mobile-pairing/releases/download/v0.1.17/SHA256SUMS). Use fixed URLs for production deployment.
