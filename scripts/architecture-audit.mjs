...
const roots = ['apps/mobile-web/src', 'packages/e2e-tunnel/src', 'packages/interaction-operations/src', 'packages/ui-layout-mobile/src']
...
const hostUiRoots = ['packages/interaction-operations/src', 'packages/ui-layout-mobile/src']
