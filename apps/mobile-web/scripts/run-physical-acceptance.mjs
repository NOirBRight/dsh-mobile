...
export function runPhysicalAcceptancePreflight() {
  ...
  const apk = resolve(import.meta.dirname, '../../../artifacts/' + (process.env.DSH_MOBILE_APK ?? 'dsh-mobile-1.1.12.apk'))
  ...
  if (installed.versionCode !== 25 || installed.versionName !== '1.1.12') {
