...
Android APK（已签名 **v1.1.4**）：

- 最新 APK：https://github.com/NOirBRight/dsh-mobile/releases/latest/download/dsh-mobile.apk
- 固定 APK：https://github.com/NOirBRight/dsh-mobile/releases/download/v1.1.4/dsh-mobile.apk
...
| [dsh-mobile](https://github.com/NOirBRight/dsh-mobile) APK | [v1.1.4](https://github.com/NOirBRight/dsh-mobile/releases/tag/v1.1.4) | 手机应用。下载固定名称 `dsh-mobile.apk`。 |
| Relay | [`relay/deploy`](relay/deploy/README.md) | 可选自托管密文转发。只用 Quick Tunnel 就跳过。 |

Release 完整性：插件 tarball 和 APK 的固定名称、SHA-256 均列在 [v1.1.4/SHA256SUMS](https://github.com/NOirBRight/dsh-mobile/releases/download/v1.1.4/SHA256SUMS)。Latest URL 永远不带版本号；生产部署请使用固定版本 URL。
